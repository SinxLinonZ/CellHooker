...
def pre_spawn_hook(spawner):
    ...
    spawner.environment = {
        ...
        'CHOWN_EXTRA_OPTS': '-R',
        'NOTEBOOK_ARGS' : '--Session.username=' + username,
        # 'GRANT_SUDO': '1',
    }
...
# c.DockerSpawner.hub_connect_ip = "127.0.0.1"
...
#  Default: '/home/h-kys/.pyenv/versions/3.8.0/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/h-kys/.pyenv/versions/3.8.0/share/jupyterhub'
